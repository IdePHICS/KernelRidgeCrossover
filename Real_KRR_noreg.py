...
def get_errors(samples, X, y, seed):
    ...
    if kernel=="polynomial":
        KRR=KernelRidge(alpha=0,kernel=kernel,degree=5,gamma=gamma)
    else:
        KRR=KernelRidge(alpha=0,kernel=kernel,gamma=gamma)
...
Df.to_csv("Data/{}/no_reg/no_reg_{}_{}_gamma{}_sigma{}_samples{}.csv".format(dataset,dataset,kernel,gamma,sigma,samples))
